...
namespace Maersk.Practice.CSharp.ConsoleUI.File_IO
{
    internal class FileClassPractice
    {
        ...
        {
            string sourcePath = "C:\\Interns.Maersk.Practice\\Maersk-Practice-CSharp\\FileClassPractice.txt";
            string targetPath = "C:\\Interns.Maersk.Practice\\Maersk-Practice-CSharp\\FileClassPractice2.txt";
